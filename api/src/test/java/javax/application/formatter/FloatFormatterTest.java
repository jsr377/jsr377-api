 ...
 */
public class FloatFormatterTest extends AbstractNumberFormatterTestCase<Float> {
    @Override
    protected Formatter<Float> createFormatter() {
        return new FloatFormatter();
    }

    @Override
    protected Formatter<Float> createFormatter(String pattern) {
        return new FloatFormatter(pattern);
    }

    protected Object[] where_simple() {
        return new Object[]{
            new Object[]{100f, "100.0"}
        };
    }
    ...
    protected Object[] where_pattern() {
        return new Object[]{
            ...
            new Object[]{PATTERN_CURRENCY, 100f, "$100.00"},
            new Object[]{PATTERN_PERCENT, 1f, "100%"},
            new Object[]{null, 100f, "100.0"},
            new Object[]{"", 100f, "100.0"},
            new Object[]{"##.0", 20f, "20.0"}
        };
    }
