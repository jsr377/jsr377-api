 ...
 */
public class IntegerFormatterTest extends AbstractNumberFormatterTestCase<Integer> {
    @Override
    protected Formatter<Integer> createFormatter() {
        return new IntegerFormatter();
    }

    @Override
    protected Formatter<Integer> createFormatter(String pattern) {
        return new IntegerFormatter(pattern);
    }
    ...
    protected Object[] where_pattern() {
        return new Object[]{
            ...
            new Object[]{PATTERN_CURRENCY, 100, "$100.00"},
            new Object[]{PATTERN_PERCENT, 1, "100%"},
            new Object[]{null, 100, "100"},
            new Object[]{"", 100, "100"},
