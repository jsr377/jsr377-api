...
import javax.application.formatter.FloatFormatter;
...
public class FloatConverter extends AbstractPrimitiveNumberConverter<Float> {
    ...
    @Override
    protected Float doConvertFromString(String value) throws ConversionException {
        try {
    ...
    @Override
    protected Formatter<Float> resolveFormatter(String format) {
