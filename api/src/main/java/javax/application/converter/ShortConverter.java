...
import javax.application.formatter.ShortFormatter;
...
public class ShortConverter extends AbstractPrimitiveNumberConverter<Short> {
    ...
    @Override
    protected Short doConvertFromString(String value) throws ConversionException {
        try {
    ...
    @Override
    protected Formatter<Short> resolveFormatter(String format) {
